...
export const StoryViewer = ({
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        className="max-w-md! w-full h-[90vh] p-0 overflow-hidden bg-black border-0"
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          {(currentGroupIndex > 0 || currentStoryIndex > 0) && (
            <Button
              variant="ghost"
              size="icon"
              className="absolute left-4 top-1/2 -translate-y-1/2 z-20 text-white bg-black/50 hover:bg-white/20 transition-colors"
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 text-white bg-black/50 hover:bg-white/20 transition-colors"
